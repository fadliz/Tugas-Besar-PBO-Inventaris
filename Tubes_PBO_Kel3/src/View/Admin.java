...
public class Admin extends javax.swing.JPanel {
    ...
    public void setListUser(ArrayList<User> list){
        ...
        for (int i = 0; i < list.size(); i++){
            if (list.get(i) instanceof Classes.Supplier){
                isi[i][0] = String.valueOf(((Classes.Supplier) list.get(i)).getID());
            } else if (list.get(i) instanceof Classes.Petugas){
                isi[i][0] = String.valueOf(((Classes.Petugas) list.get(i)).getIdPetugas());
            }
    ...
    public Object tabelUserSelected(){
    ...
    public void refreshEdit(User b) {
        if (b instanceof Classes.Supplier){
            spinIDPenggunaKelola.setValue(((Classes.Supplier) b).getID());
        } else if (b instanceof Classes.Petugas){
            spinIDPenggunaKelola.setValue(((Classes.Petugas) b).getIdPetugas());
        }
