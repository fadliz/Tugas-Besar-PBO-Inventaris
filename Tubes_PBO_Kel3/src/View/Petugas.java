...
public class Petugas extends javax.swing.JPanel {
    ...
    public int getMasukSupplier(){
        return Integer.parseInt((String) cmbMasukPenyedia.getSelectedItem());
    }
    
    public void setComboSupplierMasuk(String[] id){
        for (String i : id){
            cmbMasukPenyedia.addItem(i);
        }
    }
    
    public void setComboSupplierMasukNull(String[] id){
        for (String i : id){
    ...
    public Object getListBarangSupplier() {
    ...
    public int getSelectedNamaBarangSupplier(){
